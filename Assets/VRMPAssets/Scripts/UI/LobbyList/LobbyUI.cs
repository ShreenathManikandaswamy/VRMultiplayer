...
namespace XRMultiplayer
{
    public class LobbyUI : MonoBehaviour
    {
        ...
        public void CreateLobbyAsTrainee()
        {
            XRINetworkGameManager.Instance.SetLocalPlayerRole(XRPlayerRole.Trainee);
            CreateLobby();
        }

        public void CreateLobbyAsSafetyOfficer()
        {
            XRINetworkGameManager.Instance.SetLocalPlayerRole(XRPlayerRole.SafetyOfficer);
            CreateLobby();
        }
        ...
        public void QuickJoinLobbyAsTrainee()
        {
            XRINetworkGameManager.Connected.Subscribe(OnConnected);
            XRINetworkGameManager.Instance.QuickJoinLobbyAsTrainee();
            m_ConnectionSuccessText.text = "Joining as Trainee";
        }

        public void QuickJoinLobbyAsSafetyOfficer()
        {
            XRINetworkGameManager.Connected.Subscribe(OnConnected);
            XRINetworkGameManager.Instance.QuickJoinLobbyAsSafetyOfficer();
            m_ConnectionSuccessText.text = "Joining as Safety Officer";
        }
